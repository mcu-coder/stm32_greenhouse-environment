...
#define humi_LEN                           1
#define ts_RATIO                         1
#define ts_ADDITION                      0
#define ts_MIN                           0
#define ts_MAX                           100
#define ts_LEN                           1
#define gz_max_RATIO                         10
#define gz_max_ADDITION                      0
#define gz_max_MIN                           0
#define gz_max_MAX                           30
#define gz_max_LEN                           1
#define gz_min_RATIO                         10
#define gz_min_ADDITION                      0
#define gz_min_MIN                           0
#define gz_min_MAX                           30
#define gz_min_LEN                           1
#define wd_RATIO                         1
#define wd_ADDITION                      0
#define wd_MIN                           0
#define wd_MAX                           100
#define wd_LEN                           1
#define trsd_RATIO                         1
#define trsd_ADDITION                      0
#define trsd_MIN                           0
#define trsd_MAX                           100
#define trsd_LEN                           1
#define lux_RATIO                         1
...
typedef struct {
    ...
    uint32_t valuehumi;
    uint32_t valuets;
    uint32_t valuegz_max;
    uint32_t valuegz_min;
    uint32_t valuewd;
    uint32_t valuetrsd;
    uint32_t valuelux;
} dataPoint_t;
...
typedef struct {
    ...
    uint8_t flaghumi:1;
    uint8_t flagts:1;
    uint8_t flaggz_max:1;
    uint8_t flaggz_min:1;
    uint8_t flagwd:1;
    uint8_t flagtrsd:1;
    uint8_t flaglux:1;
} dataPointFlags_t;
